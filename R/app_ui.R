...
app_ui <- function() {
  ...
  tagList(
    ...
    waiter::use_butler(),
    waiter::use_waiter(),
    waiter::waiter_show_on_load(html = tagList(waiter::spin_chasing_dots(), br2(),
                                               h3("Fetching dataset ..."),
                                               h4("(this will take a few seconds)"))),
    ...
    navbarPage(title =  "ShinyRems", selected = '1. Data',
               ...
               tabPanel(title = "6. Guideline",
                        br(),
                        mod_guideline_ui("guideline_ui_1")),
