...
```{r, out.width = '100%', fig.cap = 'Figure 1: R code script in the RStudio program. This is the code to run to open the shinyrems app.'}
...
```{r, out.width = '100%', fig.cap = 'Figure 2. A message to answer when the code to launch the app is run. The ‘2yr’ EMS dataset is updated every day. '}
include_graphics('img/2.png')
```
 

```{r, out.width = '100%', fig.cap = 'Figure 3. A message to answer when the code to launch the app is run. This message confirms a data look up table can be stored on the users’ computer.'}
...
```{r, out.width = '100%', fig.cap = 'Figure 4. The first screen seen when the app opens in the users web brower. The dataset chosen in the R code will be listed in the top left. Raw data can be chosen multiple ways, with options to view one parameter at a time and at a specific date range.'}
...
```{r, out.width = '100%', fig.cap = 'Figure 5. Raw data can also be found by selecting monitoring site locations on the Site Map inset tab.'}
...
```{r, out.width = '100%', fig.cap = 'Figure 6. The first screen the user will see when the app opens in the users web browser when the ‘upload’ option was chosen. '}
...
```{r, out.width = '100%', fig.cap = 'Figure 7. Template of how the users’ data needs to be organized to upload into app.'}
include_graphics('img/7.png')
```
...
```{r, out.width = '100%', fig.cap = 'Figure 8. Tab 2 in ShinyRems. This tab is where the users raw data starts to be tidied and includes a few automatic and manual steps to customize the users dataset.'}
include_graphics('img/8.png')
```
...
```{r, out.width = '100%', fig.cap = 'Figure 9. The Messages inset tab of the Tidy Tab. This shows what is happening automatically in the Tidy Tab.'}
include_graphics('img/9.png')
```
...
```{r, out.width = '100%', fig.cap = 'Figure 10. The main screen of the Clean Tab. This is where various options exist for cleaning the users now tidy dataset.'}
...
```{r, out.width = '100%', fig.cap = 'Figure 11. The main tab of the Outlier screen. Options here include customizing what constitutes an outlier for the dataset and removing them if desired.'}
...
```{r, out.width = '100%', fig.cap = 'Figure 12. The main screen of the Outliers Tab showing the Final Data inset tab. This shows the final clean dataset with outliers removed.'}
...
```{r, out.width = '100%', fig.cap = 'Figure 13. The main plot screen. Here the user can view the initial visualization of the clean dataset with outliers removed. Various options exist for customizing the plot and downloading it to the users computer.'}
...
```{r, out.width = '100%', fig.cap = 'Figure 14. The Guideline inset tab showing the options for calcuating the aquatic life guideline of the variable selected in the 1. Data tab.'}
...
```{r, out.width = '100%', fig.cap = 'Figure 15. The Guideline inset tab showing the option to set the guideline manually.'}
...
```{r, out.width = '100%', fig.cap = 'Figure 16. The inset Summary Statistics tab in the main Tab 5. Plot/Statistics. Each EMS_ID will represent a row.'}
...
```{r, out.width = '100%', fig.cap = 'Figure 17. The Reference Tables tab which show all options for the various EMS columns. These show the EMS reference tables available from Data BC.'}
include_graphics('img/17.png')
```  
